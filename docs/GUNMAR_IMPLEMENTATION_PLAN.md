...
- Authenticated memory API with bounded validation and private-by-default retrieval.
...
3. Add model-backed memory extraction, deduplication, vector retrieval, and audit history.
